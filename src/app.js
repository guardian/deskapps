...
var liveblog = require('./components/liveblog')

// Ensure there's an app shortcut for toast notifications to work on Windows
if (platform.isWindows) {
  gui.App.createShortcut(process.env.APPDATA + "\\Microsoft\\Windows\\Start Menu\\Programs\\Guardian Deskapp.lnk");
}
...
iframe.onload = function() {
  ...
  liveblog.notify(win, iframe.contentWindow, document, iframe.contentDocument);
};
